...
# Aseguramos que el directorio List exista
...
if text:
    ...
    output_file = list_dir / f'{hoy}.txt'
    output_file.write_text(tabla_formateada, encoding='utf-8')

    print(f"File created: {output_file}")
else:
    error_file = list_dir / f'{hoy}_error.txt'
    error_file.write_text("Lista de diccionarios vacía.", encoding='utf-8')
